...
# NOTE:
# The purpose of this bash file is (correctly) use the FFMPEG library to download an mp3 stream to a file.
# Though this bash file can be used as is, it will be wrapped in a Python class to abstract its functionality.
